#!/bin/bash
#
# Create CloudWatch alarms for Stress environment RDS instances
...
echo -e "${BLUE}================================================================================================${NC}"
echo -e "${CYAN}${BOLD}📊 创建 Stress 环境 RDS CloudWatch 告警${NC}"
echo -e "${BLUE}================================================================================================${NC}"
...
echo -e "${YELLOW}💡 提示:${NC}"
echo -e "  - 查看所有告警:"
echo -e "    ${CYAN}aws --profile gemini-pro_ck cloudwatch describe-alarms --region ap-east-1 --alarm-name-prefix 'RDS-bingo-stress'${NC}"
echo ""
echo -e "  - 查看告警状态:"
